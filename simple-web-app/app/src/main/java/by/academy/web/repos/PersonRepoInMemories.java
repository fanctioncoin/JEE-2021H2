...
////        addGradeList();
//        personMap.put(1,1,new Coach(new CredUser("coach1","123", Role.COACH),1,"Ivan Ivanov",32,1000));
...
//
//        personMap.put(1,new Coach(1,new CredUser("coach1","123", Role.COACH),"Ivan Ivanov",32,1000));
//        personMap.put(11,new Admin(11,new CredUser("coach1","123", Role.COACH),"Ivan Ivanov",32));
//
//        return personMap;
////    }
